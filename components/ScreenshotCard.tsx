...
export const ScreenshotCard: React.FC<ScreenshotCardProps> = ({ screenshot, index, onDelete, onRunOcr, isOcrLoading }) => {
    return (
        <div className="bg-base-100 rounded-lg shadow-md overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-xl hover:border-primary transform hover:scale-105">
            <div className="relative">
                ...
                <button 
                    ...
                    className="absolute top-2 right-2 bg-red-500 text-white p-1.5 rounded-full hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
            ...
            <div className="p-4">
                ...
                <button
                    ...
                    aria-label={`Run OCR for screenshot ${index + 1}`}
                >
                    {isOcrLoading ? (
                        <>
